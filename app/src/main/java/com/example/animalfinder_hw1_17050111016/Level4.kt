...
class Level4 : AppCompatActivity(), TextToSpeech.OnInitListener {
    private var timer: Int = 11
    private var bonusPerSecond: Int = 8000 + timer * 400
    private var score: Int = 0
    private var playTimes: Int = 1
    private val animals: MutableList<Animal> = AnimalList().getRandomAnimal(6)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        twLevelTimer.text = "$timer"
        twLevelName.text = "Level 4 (Stage $playTimes/3)"
