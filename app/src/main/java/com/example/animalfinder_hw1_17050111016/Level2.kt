...
class Level2 : AppCompatActivity(), TextToSpeech.OnInitListener {
    private var timer: Int = 17
    private var bonusPerSecond: Int = 2000 + timer * 100
    private var score: Int = 0
    private var playTimes: Int = 1
    private val animals: MutableList<Animal> = AnimalList().getRandomAnimal(3)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        twLevelTimer.text = "$timer"
        twLevelName.text = "Level 2 (Stage $playTimes/3)"
